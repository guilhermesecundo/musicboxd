    ...
    with open("script_songs.sql", "w") as output:
        for i, line in enumerate(songs):
            ...
            if artist not in artists_list:
                ...
                output.write("INSERT INTO artists VALUES("+artist+", \"EUA\");\n")
            if album not in album_list:
                album_list.append(album)
                output.write("INSERT INTO albums VALUES("+album+", "+date+", "+str(artists_list.index(artist))+");\n")
            output.write("INSERT INTO musics VALUES("+song+", "+date+", "+duration+", "+str(artists_list.index(artist))+", "+str(album_list.index(album))+");\n")
